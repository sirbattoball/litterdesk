...
export default function RegisterPage() {
  ...
  return (
    <div style={{minHeight:'100vh',background:'radial-gradient(ellipse at 15% 60%, rgba(196,217,200,.2) 0%, transparent 55%), radial-gradient(ellipse at 85% 20%, rgba(200,117,26,.07) 0%, transparent 50%), var(--paper)',display:'flex',alignItems:'stretch'}}>

      {/* Left panel */}
      <div style={{flex:'0 0 420px',display:'flex',flexDirection:'column',justifyContent:'center',padding:'48px 48px',borderRight:'1px solid rgba(230,223,212,.6)',background:'rgba(255,255,255,.5)',backdropFilter:'blur(20px)'}}>
        ...
        <div style={{width:'100%',maxWidth:440}}>
          <div className="auth-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="field"><label className="label">Kennel name <span style={{color:'var(--ink-4)',fontWeight:400}}>(optional)</span></label><input className="input" placeholder="Sunrise Goldens" value={form.kennel_name} onChange={e=>setForm(f=>({...f,kennel_name:e.target.value}))} /></div>
