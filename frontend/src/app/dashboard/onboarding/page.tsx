...
export default function OnboardingPage() {
  ...
  const [litter, setLitter] = useState({ breed: 'Golden Retriever', status: 'planned', num_males: '', num_females: '', puppy_price: '', go_home_date: '' })
        ...
        {step === 1 && (
          <div className="card animate-fade-in-up" style={{padding:32}}>
            <div style={{marginBottom:24}}>
              ...
              <h2 style={{fontFamily:'var(--serif)',fontSize:28,color:'var(--ink)',marginBottom:8,letterSpacing:'-.2px'}}>Add your first litter</h2>
        ...
        {step === 2 && (
          <div className="card animate-fade-in-up" style={{padding:32}}>
            <div style={{marginBottom:24}}>
              ...
              <h2 style={{fontFamily:'var(--serif)',fontSize:28,color:'var(--ink)',marginBottom:8,letterSpacing:'-.2px'}}>Add your dam or sire</h2>
